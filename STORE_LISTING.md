...
| `bookmarks` | The bookmark palette (Shift+B / voice "palette bookmarks"): search bookmarks by title, site, or folder and open one in a new tab. Read-only — the extension never creates, edits, or deletes bookmarks, and bookmark data never leaves the browser. |
