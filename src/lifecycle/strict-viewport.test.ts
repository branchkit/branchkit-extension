...
// (The settle pipeline's strict delta comes from computeStrictDeltaPlan over
// the gather snapshot — covered in reconcile.test.ts. This live-read variant
// serves only the out-of-pipeline re-push.)
